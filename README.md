...
1. **Install & Upgrade:**
   ...
   ```bash
   bash <(curl -Ls https://raw.githubusercontent.com/bignstrong/DucksNet/refs/heads/master/scripts/install.sh) -q
   cd DucksNet
   ```
...
| BOT_DOMAIN                     | 🔴       | -                                                       | Domain of the bot (e.g., DucksNet.com)                                                 |
| BOT_PORT                       | ⭕       | 8080                                                    | Port of the bot                                                                        |
|                                |          |                                                         |
| SHOP_EMAIL                     | ⭕       | support@DucksNet.com                                    | Email for receipts                                                                     |
...
1. **Webhook Setup:**
   ...
   - Enter the bot’s domain in the notification URL, ending with `/yookassa` (e.g., `https://DucksNet.com/yookassa`).
...
1. **Webhook Setup:**
   ...
   - Enter the bot’s domain in the notification URL, ending with `/yoomoney` (e.g., `https://DucksNet.com/yoomoney`).
